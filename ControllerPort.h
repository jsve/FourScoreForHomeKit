 ...
 *
 * Besides this, the controller port is also defined as a MeasuringControllerPort.
 * this represents the physical port and is not exposed directly to HomeKit. Its
 * subscribers will be Players, which in turn have ControllerPorts that are exposed.
 * This means that there will be a 1:4 relationship between MeasuringControllerPorts
 * and ControllerPorts. This is to make things look nice in HomeKit.
 */
